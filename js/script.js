...
function playApp(){
	...
	console.log('reiniciar() -> Reinicia el player');
	console.log('capturaDePantalla() -> Te da un texto y lo pegas en esta pagina: https://codebeautify.org/base64-to-image-converter')
